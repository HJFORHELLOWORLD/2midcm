var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
    ...
    THISPAGE = {
        ...
        initDom: function(t) {
            ...
            this.$_planId = $("#planId");
            this.$_BOMName = $("#BOMName");
            this.$_unitName = $("#unitName");
            this.$_BOM_Accountt = $("#BOM_Accountt");
/*            this.$_extraQty = $("#extraQty");
...
//					})
            ...
            var i = '<a id="edit" class="ui-btn">保存</a>',
                ...
                afterSaveCell: function(t, i, a, r, n) {
                    switch (i) {
                        ...
                        case "extraQty":
                            var a = parseFloat(a),
                                m = parseFloat($("#grid").jqGrid("getCell", t, n - 1));
                            if ($.isNumeric(m) && $.isNumeric(a)) var total = m + a,
                                p = $("#grid").jqGrid("setRowData", t, {
                                    totalQty: total
                                });
                            e(t);
        ...
        disableEdit: function() {
            this.$_extraQty.attr("disabled", "disabled").addClass("ui-input-dis");
            this.$_reason.attr("disabled", "disabled").addClass("ui-input-dis");
            this.$_totalQty.attr("disabled", "disabled").addClass("ui-input-dis");
            $("#grid").jqGrid("setGridParam", {
                cellEdit: !1
            });
            this.editable = !1
        ...
        addEvent: function() {
            ...
            $(".wrapper").on("click", "#edit", function(t) {
                ...
                if (Business.verifyRight("PU_UPDATE")) {
                    ...
                    e && Public.ajaxPost(invpu_planEdit, {
        ...
        _getEntriesData: function() {
            for (var t = [], e = $("#grid").jqGrid("getDataIDs"), i = 0, a = e.length; a > i; i++) {
                ...
                if ("" !== o.goods) {
                    ...
                    if(o.extraQty != parseFloat(0) && o.reason == ''){
                        return false;
                    }
                    t.push(r)
                }
