var queryConditions = {
    ...
    THISPAGE = {
        ...
        loadGrid: function() {
            function t(t, e, i) {
                var a = '<div id="aaa" class="operating" data-id="' + i.id + '" data-billno="' + i.PK_BOM_Pur_ID + '"><a class="ui-icon ui-icon-search" title="查看"></a><a class="pass">通过</a>&nbsp;&nbsp;<a class="fail">不通过</a></div>';
                return a
            }
            function e(t, e, i) {
