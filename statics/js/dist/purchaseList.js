		...
		loadGrid: function() {
			function t(t, e, i) {
				if(1 == i.review || 3 == i.review) {
                    var a = '<div class="operating" data-id="' + i.PK_BOM_Pur_ID + '"><a class="ui-icon ui-icon-pencil" title="修改"></a><a class="ui-icon ui-icon-trash" title="删除"></a></div>';
                }
                if (2 == i.review){
					var a = '<div class="operating" data-id="' + i.PK_BOM_Pur_ID + '"><a class="ui-icon ui-icon-search" title="查看"></a><a class="ui-icon ui-icon-copy"  title="入库"></a><a class="ui-icon ui-icon-trash" title="删除"></a></div>';
                }
                if (9 == i.review){
                    var a = '<div class="operating" data-id="' + i.PK_BOM_Pur_ID + '"><a class="ui-icon ui-icon-search" title="查看"></a><span style="color: red">已入库</div>';
                }return a
			}
			function e(t, e, i) {
			...
			$("#grid").jqGrid({
				...
				gridview: !0,
				multiselect: !0,
				colNames: ["操作", "日期", "订单编号"/*, "业务类别"*/, "订单名称", "供应商", "订单总金额","付款条件", "制单人","审核状态"],
				colModel: [{
					name: "operating",
					width: 80,
					fixed: !0,
