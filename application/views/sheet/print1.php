...
var report_sheet_detail = "<?=site_url('report/sheet_detail')?>";
var report_sheet_detail_xls = "<?=site_url('report/sheet_detail_xls')?>";
</script>
  	...
  	<div class="grid">
		...
		<table class="list" width="900">
				<tr>
					...
					<td width="110" align="center"><b>报价单价<b></td>
					<td width="110" align="center"><b>折扣率(%)<b></td>	
					<td width="110" align="center"><b>折扣额<b></td>	
					<td width="110" align="center"><b>报价金额<b></td>
				</tr>
			  <?php 
			  $i = 1;
