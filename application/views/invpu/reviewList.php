...
<head>
    ...
    <script type="text/javascript">
        ...
        var invpu_purchaseReviewList = "<?=site_url('invpu/purchaseReviewList')?>";
        var invpu_review = "<?=site_url('invpu/review')?>";
    </script>
    <style>
...
<script src="<?=skin_url()?>/js/dist/purchaseReviewList.js?2"></script>
</body>
</html>