...
<head>
    ...
    <script type="text/javascript">
        ...
        var invpu_planImport    = "<?=site_url('invpu/planImport')?>";
        var invpu_purchasePlanInfo = "<?=site_url('invpu/purchasePlanInfo')?>";
        var invpu_planEdit = "<?=site_url('invpu/planEdit')?>";
        var invpu_purchasePlan = "<?=site_url('invpu/purchasePlan')?>";
        var settings_purchasePlan_info = "<?=site_url('settings/purchasePlan_info')?>";
    </script>
    <style>
        ...
        <div class="fl">
            <ul class="ul-inline">
                ...
                <li><a class="ui-btn" id="search">查询</a><!--<a class="ui-btn ui-btn-refresh" id="refresh" title="刷新"><b></b></a>-->
                    <a class="ui-btn" id="update">实时更新</a></li>
            </ul>
        </div>
...
<script src="<?=skin_url()?>/js/dist/purchasePlanList.js?2"></script>
</body>
</html>