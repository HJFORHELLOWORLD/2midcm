...
<head>
    ...
    <script type="text/javascript">
        ...
        var settings_invpu_info    = "<?=site_url('settings/invpu_info')?>";
        var invsa_salesReviewList = "<?=site_url('invsa/salesReviewList')?>";
        var invsa_review = "<?=site_url('invsa/review')?>";
...
<div class="wrapper">
    <div class="mod-search cf">
        <div class="fl">
            <ul class="ul-inline">
                <li>
                    <input type="text" id="matchCon" class="ui-input ui-input-ph" value="请输入购货单号或供应商名或制单人名">
                </li>
                <li>
                    <label>日期:</label>
...
<script src="<?=skin_url()?>/js/dist/salesReviewList.js?2"></script>
</body>
</html>