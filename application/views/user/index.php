...
var settings_user_manage = "<?=site_url('settings/user_manage')?>";       //人员增修改

var user_del = "<?=site_url('user/del')?>";
</script>
</head>
<body>
<div class="wrapper">
	<div class="mod-toolbar-top cf">
	    <div class="fl"><strong class="tit">人员管理</strong></div>
...
<script src="<?=skin_url()?>/js/dist/userList.js?00009999"></script>
</body>
</html>